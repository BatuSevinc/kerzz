...
const ToggleMenu = ({toggleMenu,setToggleMenu}) => {
  return (
    <div className={`menu-box-shadow z-10 fixed flex pl-20 flex-col items-center justify-center gap-10 bg-[#F5F5F5] w-[100vw] h-[100vh] top-0 duration-1000 ${toggleMenu ? "translate-x-[-80px] md:translate-x-[-8000px]" : "translate-x-[-1150px] md:translate-x-[-11500px]"} transition-all border-r border-[#b4b3b3]`}>
